...
require (
	...
	github.com/wasilak/loggergo v1.3.0
	github.com/wasilak/otelgo v1.1.0
...
require (
	...
	gitlab.com/greyxor/slogor v1.2.10 // indirect
	...
	go.opentelemetry.io/otel/exporters/otlp/otlplog/otlploggrpc v0.0.0-20240804103558-f079b0336474 // indirect
