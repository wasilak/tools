...
require (
	...
	github.com/samber/lo v1.41.0 // indirect
	...
	gitlab.com/greyxor/slogor v1.2.9 // indirect
	...
	go.opentelemetry.io/otel/exporters/otlp/otlplog/otlploggrpc v0.0.0-20240627150351-1d783e14f7a2 // indirect
